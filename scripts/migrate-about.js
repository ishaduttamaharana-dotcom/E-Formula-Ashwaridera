...
//  Directly migrates the singleton about_content document in MongoDB
//  to the complete 14-section schema with full publishedVersion snapshot.
// ============================================================
...
const defaultDocData = {
  ...
  departments: {
    ...
    items: [
      { id: 'dept-1', name: 'Powertrain', icon: 'fas fa-gas-pump', teamLead: 'Team Lead', description: 'Motor & controller, battery management, thermal systems.', responsibilities: ['Motor & controller', 'Battery management', 'Thermal systems'], order: 0, visible: true },
      { id: 'dept-2', name: 'Drivetrain', icon: 'fas fa-cogs', teamLead: 'Team Lead', description: 'Transmission, differential, axles & bearings.', responsibilities: ['Transmission', 'Differential', 'Axles & bearings'], order: 1, visible: true },
      { id: 'dept-3', name: 'Aerodynamics', icon: 'fas fa-wind', teamLead: 'Team Lead', description: 'CFD & FEA, wings & bodywork, downforce optimization.', responsibilities: ['CFD & FEA', 'Wings & bodywork', 'Downforce optimization'], order: 2, visible: true },
      { id: 'dept-4', name: 'Data Acquisition', icon: 'fas fa-chart-line', teamLead: 'Team Lead', description: 'Telemetry, sensors & logging, data analysis.', responsibilities: ['Telemetry', 'Sensors & logging', 'Data analysis'], order: 3, visible: true },
      { id: 'dept-5', name: 'Vehicle Dynamics', icon: 'fas fa-car', teamLead: 'Team Lead', description: 'Handling & setup, kinematics, tire modelling.', responsibilities: ['Handling & setup', 'Kinematics', 'Tire modelling'], order: 4, visible: true },
      { id: 'dept-6', name: 'System Integration', icon: 'fas fa-microchip', teamLead: 'Team Lead', description: 'ECU & wiring, controls, dashboard & UI.', responsibilities: ['ECU & wiring', 'Controls', 'Dashboard & UI'], order: 5, visible: true },
      { id: 'dept-7', name: 'Firmware', icon: 'fas fa-code', teamLead: 'Team Lead', description: 'Embedded C, low-level control, RTOS & comms.', responsibilities: ['Embedded C', 'Low-level control', 'RTOS & comms'], order: 6, visible: true },
      { id: 'dept-8', name: 'Brakes', icon: 'fas fa-circle', teamLead: 'Team Lead', description: 'Hydraulics, disc & caliper, ABS strategy.', responsibilities: ['Hydraulics', 'Disc & caliper', 'ABS strategy'], order: 7, visible: true },
      { id: 'dept-9', name: 'Steering', icon: 'fas fa-dharmachakra', teamLead: 'Team Lead', description: 'Rack & pinion, column & quick-release, driver feedback.', responsibilities: ['Rack & pinion', 'Column & quick-release', 'Driver feedback'], order: 8, visible: true },
      { id: 'dept-10', name: 'Suspension', icon: 'fas fa-arrows-alt-v', teamLead: 'Team Lead', description: 'Springs & dampers, anti-roll bars, uprights & wishbones.', responsibilities: ['Springs & dampers', 'Anti-roll bars', 'Uprights & wishbones'], order: 9, visible: true },
    ],
  },
  process: {
    visible: true,
    ...
    stages: [
      { id: 'proc-1', stepNumber: '01', name: 'Research', description: "We study last season's data, rulebook changes, and competitor designs to set performance targets for the new car.", order: 0, visible: true },
      { id: 'proc-2', stepNumber: '02', name: 'Concept Design', description: 'Cross-department reviews translate targets into a system architecture — chassis layout, battery and motor package, and packaging constraints.', order: 1, visible: true },
      { id: 'proc-3', stepNumber: '03', name: 'CAD Modeling', description: 'Every component is modelled in full assembly CAD before a single part is manufactured, catching fit and clearance issues early.', order: 2, visible: true },
      { id: 'proc-4', stepNumber: '04', name: 'Simulation', description: 'FEA, CFD, and lap-time simulation validate structural integrity, aero performance, and expected track performance.', order: 3, visible: true },
      { id: 'proc-5', stepNumber: '05', name: 'Manufacturing', description: 'Parts are machined, welded, and composited in-house and with manufacturing partners, following our build drawings exactly.', order: 4, visible: true },
      { id: 'proc-6', stepNumber: '06', name: 'Assembly', description: 'Sub-systems come together on the rolling chassis, with torque specs and wiring checked against the build manual.', order: 5, visible: true },
      { id: 'proc-7', stepNumber: '07', name: 'Testing', description: 'Shakedown runs, endurance simulation, and driver seat-time tune the car before it ever reaches scrutineering.', order: 6, visible: true },
      { id: 'proc-8', stepNumber: '08', name: 'Competition', description: 'Scrutineering, static events, and dynamic events at Formula Bharat — the culmination of a full season’s work.', order: 7, visible: true },
    ],
  },
  formulaBharat: {
    visible: true,
    ...
    facts: [
      { id: 'fb-1', label: 'Engineering Design', url: '', order: 0, visible: true },
      { id: 'fb-2', label: 'Cost & Manufacturing', url: '', order: 1, visible: true },
      { id: 'fb-3', label: 'Business Presentation', url: '', order: 2, visible: true },
      { id: 'fb-4', label: 'Acceleration', url: '', order: 3, visible: true },
      { id: 'fb-5', label: 'Skidpad', url: '', order: 4, visible: true },
      { id: 'fb-6', label: 'Autocross', url: '', order: 5, visible: true },
      { id: 'fb-7', label: 'Endurance', url: '', order: 6, visible: true },
    ],
  },
  workshop: {
    visible: true,
    ...
    items: [
      { id: 'ws-1', title: 'CAD Lab', imageUrl: 'https://res.cloudinary.com/frjck4sc/image/upload/v1784483846/SAVE_20260111_173616.jpg_1_srifam.jpg', description: 'Design and modeling workstations.', icon: 'fas fa-cube', order: 0, visible: true },
      { id: 'ws-2', title: 'Manufacturing', imageUrl: 'https://res.cloudinary.com/frjck4sc/image/upload/v1784483829/1768116510403.jpg_1_ibfo5t.jpg', description: 'Machining, welding, and fabrication tools.', icon: 'fas fa-industry', order: 1, visible: true },
      { id: 'ws-3', title: 'Assembly', imageUrl: 'https://res.cloudinary.com/frjck4sc/image/upload/v1784483764/2026011201302668.jpg_1_vlfcsb.jpg', description: 'Vehicle integration bay and wiring station.', icon: 'fas fa-toolbox', order: 2, visible: true },
      { id: 'ws-4', title: 'Testing', imageUrl: 'https://res.cloudinary.com/frjck4sc/image/upload/v1784483702/WhatsApp_Image_2026-06-14_at_12.13.28_AM_h0tl39.jpg', description: 'Dyno, sensor calibration, and shakedown area.', icon: 'fas fa-gauge-high', order: 3, visible: true },
      { id: 'ws-5', title: 'Workshop', imageUrl: 'https://res.cloudinary.com/frjck4sc/image/upload/v1784483677/IMG-20260227-WA0016.jpg_n48hsu.jpg', description: 'Main garage and vehicle prep space.', icon: 'fas fa-warehouse', order: 4, visible: true },
      { id: 'ws-6', title: 'Competition Prep', imageUrl: 'https://res.cloudinary.com/frjck4sc/image/upload/v1784483679/WhatsApp_Image_2026-06-14_at_12.16.57_AM_1_ohzzaa.jpg', description: 'Scrutineering readiness and packing bay.', icon: 'fas fa-flag-checkered', order: 5, visible: true },
    ],
  },
  peopleMessages: {
    visible: true,
    ...
    messages: [
      {
        ...
        description: 'Faculty advisor overseeing mechanical engineering, chassis validation, and institutional coordination.',
        linkedinUrl: '#',
        order: 0,
        visible: true,
      },
      {
        ...
        description: 'Leading cross-departmental operations and powertrain integration.',
        linkedinUrl: '#',
        order: 1,
        visible: true,
      },
...
async function run() {
  try {
    ...
    if (!doc) {
      ...
      console.log('Migrating existing document (' + doc._id + ')...');
      // Preserve existing hero if edited
      const existingHero = doc.hero ? (doc.hero.toObject ? doc.hero.toObject() : doc.hero) : {};
      
      const sections = [
        'settings', 'whoWeAre', 'story', 'visionMission',
      ...
      sections.forEach(sec => {
        const cur = doc[sec];
        if (!cur || (typeof cur === 'object' && Object.keys(cur.toObject ? cur.toObject() : cur).length <= 1)) {
          doc.set(sec, defaultDocData[sec]);
        } else if (defaultDocData[sec].items && (!cur.items || cur.items.length === 0)) {
          doc.set(sec, defaultDocData[sec]);
        }
      });

      if (existingHero.title) {
        doc.set('hero', Object.assign({}, defaultDocData.hero, existingHero));
      } else {
        doc.set('hero', defaultDocData.hero);
      }
    }
    ...
    await doc.save();
    console.log('✅ Successfully migrated and published full 14-section About content in MongoDB Atlas!');
